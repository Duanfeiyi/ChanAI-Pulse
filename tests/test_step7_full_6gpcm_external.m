% Real external Full 6GPCM Step 7 two-candidate smoke test.
...
config = default_grid_search_config("full_6gpcm");
config.generator_config = targetConfig;
config.parameter_space = struct( ...
    "DS_mu", [targetConfig.model.DS_mu, ...
...
assert(result.manifest.backend == "full_6gpcm");
...
fprintf("PASS: real Full 6GPCM Step 7 two-candidate Grid Search.\n");
