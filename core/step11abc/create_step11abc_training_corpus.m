...
versionedDefaults = step11abc_versioned_generator_defaults(engineRoot);
fallback = struct("values", versionedDefaults.values, ...
    "parameter_names", versionedDefaults.parameter_names);
for groupIndex = 1:groupCount
    ...
    profile = struct( ...
        ...
        "source", "embedded_reference_profile", ...
        "parameter_sources", repmat("versioned_default", size(names)), ...
        "fallback_parameter_names", names, "fallback_used", true);
    ...
    allValues(indices, :) = createSmoothRoute(profile.values, bounds, ...
        groupIndex, routeConfig.seed, rowsPerGroup);
...
corpus = struct( ...
    ...
    "config", stepConfig, ...
    "generator_defaults", versionedDefaults, ...
    "sequence", sequence, ...
    "bundles", bundles, ...
    ...
    "summary", struct( ...
        ...
        "expected_examples_per_route", rowsPerGroup - ...
            stepConfig.data.context_length - stepConfig.data.target_length + 1, ...
        "expected_train_examples", ...
            stepConfig.data.split_group_counts(1) * (rowsPerGroup - ...
            stepConfig.data.context_length - stepConfig.data.target_length + 1)));
end

function values = createSmoothRoute(baseValues, bounds, groupIndex, ...
        masterSeed, sampleCount)
