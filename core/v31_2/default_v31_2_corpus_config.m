...
config.description = "Public Full 6GPCM scenario-profile-derived parameter corpus for reproducible v3.1 experiments";
...
config.route.configuration_role = "catalog_metadata_only";
