...
| V3-REQ-002 | 规定内插和外推的数据输入格式 | 模块一 | 1 | `DATA_CONTRACT.md`、HDF5 往返和跨语言样例 | 进行中 |
| V3-REQ-003 | 明确区分 `N_sample/Tx/Rx/Nt/Nf/Npath` | 模块一 | 1、4 | 五维 CTF/CIR 维度验证测试 | 进行中 |
...
| V3-REQ-018 | 正式输出保存版本、配置、随机种子和来源 | 全部 | 1、6、10、11 | Step 1 定义 schema/source/seed 字段；后续 Run Manifest 重载测试 | 进行中 |
