...
| V3-REQ-018 | 正式输出保存版本、配置、随机种子和来源 | 全部 | 1、6、7、10、11 | Step 6 `GenerationManifest` 与 Step 7 搜索版本、公开配置、候选统计、固定种子来源、最佳分数、运行时间和路径脱敏 Manifest 已合并；Predictor/重建输出仍待 Step 10～11 | 进行中 |
